    ...
    <Form {...form}>
      ...
      >
        ...
        <CustomFormField
            ...
            name="allergies"
            label="Allergies (if any) Provider"
        ...
        <CustomFormField
            ...
            placeholder="e.g. type 2 diabetes, asthma, heart disease"
          />
          <CustomFormField
            control={form.control}
            fieldType={FormFieldType.TEXTAREA}
            ...
            placeholder="e.g. right ankle sprained, back pain"
          />
        </div>
        <section className="space-y-6 ">
          <div className="mb-9 space-y-1">
